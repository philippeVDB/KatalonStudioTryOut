...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Username_username'), 'John Doe', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeElementScreenshotAsCheckpoint('ProbeerselCheckpointScreen_01', findTestObject('Object Repository/Page_CURA Healthcare Service/a_Make Appointment'))
