...
def setUp() {
	println ' I am inside Suite SetUp SUITE '
}
...
def tearDown() {
	println ' I am inside Suite TearDown SUITE '
}
...
def setupTestCase() {
	println ' I am inside TestCase SetUp SUITE '
}
...
def tearDownTestCase() {
	println ' I am inside TestCase TearDown SUITE '
}
